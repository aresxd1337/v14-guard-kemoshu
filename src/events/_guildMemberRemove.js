...
module.exports = {
    ...
    ws: false,
    run: async (kemo) => {
        let pic = await kemo.guild.fetchAuditLogs({ type: "MEMBER_KICK" }).then(a => a.entries.first());
        ...
        if (ibne.bannable) ibne.ban({ reason: `kemo Üye Banlama Koruması` });
